 ...
 * @author AbeXo
 */
public class Inputip extends javax.swing.JFrame {

    /**
     * Creates new form Inputip
     */
    public Inputip() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Configure = new javax.swing.JToggleButton();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(ipaddress, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(144, 144, 144)
    ...
    private void ConfigureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfigureActionPerformed
        ...
        port=ipaddress.getText();
        if(port.equals("")){ JOptionPane.showMessageDialog(null,"Enter the ip address of the server");}
        else{config.setportnumber(port);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inputip.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Inputip().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JToggleButton Configure;
